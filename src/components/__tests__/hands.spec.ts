...
import { PlayerIdsInOrder, Players } from '../players.ts'
import { PointsLadder } from '../game_constants.ts'
import { Lang } from '../app_constants.ts'
...
describe('Hand Set Up Next Hand', () => {
  ...
  it('should work for multi-ron including dealer', () => {
    Object.assign(hand, {
      state: HandState.FINISHED,
      round_wind: Winds.SOUTH,
      hand: 1,
  ...
  it('should work for multi-ron excluding dealer', () => {
    Object.assign(hand, {
      state: HandState.FINISHED,
      round_wind: Winds.SOUTH,
      hand: 1,
...
describe('Hand Finish', () => {
  ...
  it('should reject empty winner on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject multiple winner on ron with head bump on', () => {
    ruleset.head_bump = true
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
      outcome: HandOutcomeEnum.RON,
      winner: [Winds.WEST, Winds.SOUTH],
      deal_in: Winds.EAST,
      han: [3, 3],
      fu: [30, 25]
    }
  ...
  it('should accept multiple winner on ron with head bump off', () => {
    ruleset.head_bump = false
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject empty han on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject invalid han size on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject undefined fu on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject empty fu on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject invalid fu size on ron', () => {
    ruleset.head_bump = false
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
  ...
  it('should reject null fu with small han on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should accept undefined pao on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject invalid pao size on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
    ...
    hand_results.pao = [Winds.WEST, Winds.East]
    expect(hand.Finish(hand_results, players, ruleset)).toEqual(false)
    expect(hand.IsOngoing()).toBe(true)
  })
  it('should reject pao for han that is not paoable on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject when pao equals winner on ron', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should accept mixed valid pao on ron', () => {
    ruleset.head_bump = false
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
      outcome: HandOutcomeEnum.RON,
      winner: [Winds.SOUTH, Winds.EAST, Winds.WEST],
      deal_in: Winds.NORTH,
      han: [PointsLadder.YAKUMAN, 3, PointsLadder.DOUBLE_YAKUMAN],
      fu: [null, 40, null],
      pao: [Winds.WEST, null, Winds.SOUTH]
    }
    expect(hand.Finish(hand_results, players, ruleset)).toEqual(true)
    expect(hand.IsOngoing()).toBe(false)
  })
  ...
  it('should reject empty or undefined winner on tsumo', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject multiple winner on tsumo', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
      outcome: HandOutcomeEnum.TSUMO,
      winner: [Winds.EAST, Winds.NORTH],
      han: [3],
      fu: [30]
    }
    ruleset.head_bump = true
  ...
  it('should reject empty or undefined han on tsumo', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject null fu with small han on tsumo', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject invalid pao size on tsumo', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject pao equals winner on tsumo', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
  ...
  it('should reject pao when han is not paoable on tsumo', () => {
    Object.assign(hand, {
      state: HandState.ON_GOING
    })
    hand_results = {
...
describe.each([{ deal_in: Winds.SOUTH }, { deal_in: Winds.WEST }, { deal_in: Winds.NORTH }])(
  ...
  ({ deal_in }) => {
    it.each([
      ...
      { han: [PointsLadder.MANGAN], fu: [null], expected_delta: 12000 },
      { han: [PointsLadder.HANEMAN], fu: [null], expected_delta: 18000 },
      { han: [PointsLadder.BAIMAN], fu: [null], expected_delta: 24000 },
      { han: [PointsLadder.SANBAIMAN], fu: [null], expected_delta: 36000 },
      { han: [PointsLadder.YAKUMAN], fu: [null], expected_delta: 48000 }
...
describe('Hand Finish Applies Points Delta When Dealer Tsumo', () => {
  it.each([
    ...
    { han: [PointsLadder.MANGAN], fu: [null], expected_delta: 4000 },
    { han: [PointsLadder.HANEMAN], fu: [null], expected_delta: 6000 },
    { han: [PointsLadder.BAIMAN], fu: [null], expected_delta: 8000 },
    { han: [PointsLadder.SANBAIMAN], fu: [null], expected_delta: 12000 },
    { han: [PointsLadder.YAKUMAN], fu: [null], expected_delta: 16000 }
  ])(`on $han, $fu`, ({ han, fu, expected_delta }) => {
    ruleset.round_up_mangan = false
    Object.assign(hand, {
      state: HandState.ON_GOING
  ...
  it.each([
    ...
    { han: [PointsLadder.MANGAN], fu: [null], honba: 3, honba_points: 300, expected_delta: 4300 },
    { han: [2], fu: [30], honba: 1, honba_points: 1500, expected_delta: 1500 },
    { han: [PointsLadder.MANGAN], fu: [null], honba: 3, honba_points: 1500, expected_delta: 5500 }
...
describe.each([
  ...
  it.each([
    ...
    { han: [PointsLadder.MANGAN], fu: [null], expected_delta: 8000 },
    { han: [PointsLadder.HANEMAN], fu: [null], expected_delta: 12000 },
    { han: [PointsLadder.BAIMAN], fu: [null], expected_delta: 16000 },
    { han: [PointsLadder.SANBAIMAN], fu: [null], expected_delta: 24000 },
    { han: [PointsLadder.YAKUMAN], fu: [null], expected_delta: 32000 }
  ])(`on $han, $fu`, ({ han, fu, expected_delta }) => {
    ruleset.round_up_mangan = false
    Object.assign(hand, {
      state: HandState.ON_GOING
  ...
  it.each([
    ...
    { han: [PointsLadder.BAIMAN], fu: [null], honba: 3, honba_points: 300, expected_delta: 16900 },
    { han: [2], fu: [30], honba: 1, honba_points: 1500, expected_delta: 3500 },
    { han: [PointsLadder.BAIMAN], fu: [null], honba: 3, honba_points: 1500, expected_delta: 20500 }
...
describe.each([
  ...
  {
    winner: [Winds.SOUTH, Winds.WEST],
    deal_in: Winds.EAST,
    han: [2, PointsLadder.YAKUMAN],
    fu: [30, null],
    pao: [null, Winds.SOUTH],
    riichi_sticks: 2,
    honba: 1,
    expected_points_delta: {
      [Winds.EAST]: -2300 - 16000,
      [Winds.SOUTH]: 2300 - 16000 + 2000,
      [Winds.WEST]: 32000
    }
  },
  {
    winner: [Winds.SOUTH, Winds.WEST, Winds.NORTH],
    deal_in: Winds.EAST,
    han: [PointsLadder.YAKUMAN, PointsLadder.DOUBLE_YAKUMAN, PointsLadder.TRIPLE_YAKUMAN],
    fu: [null, null, null],
    pao: [Winds.NORTH, Winds.SOUTH, Winds.WEST],
    riichi_sticks: 2,
    honba: 1,
    expected_points_delta: {
      [Winds.EAST]: -32000 / 2 - 64000 / 2 - 96000 / 2,
      [Winds.SOUTH]: 32000 - 64000 / 2 + 2000 + 300,
      [Winds.WEST]: 64000 - 96000 / 2,
      [Winds.NORTH]: 96000 - 32000 / 2 - 300
    }
  }
])(
  'Hand Finish Applies Points Delta for Pao on $winner ron $han $fu $pao',
  ({ winner, deal_in, han, fu, pao, riichi_sticks, honba, expected_points_delta }) => {
    it('points delta are correct', () => {
      ruleset.round_up_mangan = false
      ruleset.head_bump = false
      Object.assign(hand, {
        state: HandState.ON_GOING,
      ...
      hand_results = {
        ...
        fu: fu,
        pao: pao,
        points_delta: expected_points_delta
      }
      expect(hand.Finish(hand_results, players, ruleset)).toBe(true)
      expect(hand.IsFinished()).toBe(true)
      for (const player_id of PlayerIdsInOrder) {
        if (player_id in Object.keys(expected_points_delta)) {
          expect(players.GetPlayer(player_id).points).toEqual(
            25000 + expected_points_delta[player_id]
          )
        }
      }
      expect(hand.results).toEqual(hand_results)
...
describe.each([
  ...
  'Hand Finish Applies Points Delta for Pao on $winner tsumo $han $fu $pao',
  ({ winner, han, fu, pao, riichi_sticks, honba, expected_points_delta }) => {
    it('points delta are correct', () => {
      ruleset.round_up_mangan = false
      ruleset.head_bump = false
      Object.assign(hand, {
...
describe.each([
  {
    winner: [Winds.EAST, Winds.SOUTH],
    deal_in: Winds.WEST,
    han: [3, PointsLadder.MANGAN],
    fu: [25, null],
    riichi_sticks: 2,
    honba: 1,
    expected_points_delta: {
  ...
  {
    winner: [Winds.EAST, Winds.WEST, Winds.NORTH],
    deal_in: Winds.SOUTH,
    han: [1, PointsLadder.MANGAN, 2],
    fu: [40, null, 30],
    riichi_sticks: 1,
    honba: 3,
    expected_points_delta: {
  ...
  {
    winner: [Winds.NORTH, Winds.SOUTH],
    deal_in: Winds.EAST,
    han: [PointsLadder.MANGAN, 4],
    fu: [null, 25],
    riichi_sticks: 5,
    honba: 0,
    expected_points_delta: {
  ...
  'Hand Finish Applies Points Delta When Multiple Ron on $winner $han $fu',
  ({ winner, deal_in, han, fu, riichi_sticks, honba, expected_points_delta }) => {
    it('points delta are correct', () => {
      ruleset.round_up_mangan = false
      ruleset.head_bump = false
      Object.assign(hand, {
...
describe('Hand Clone', () => {
  ...
  it('should copy all fields correctly for multiple winners', () => {
    Object.assign(hand, {
      state: HandState.FINISHED,
      round_wind: Winds.SOUTH,
      hand: 3,
...
describe('Hand Parse From Object', () => {
  ...
  it('should copy all fields correctly for multiple winner', () => {
    Object.assign(hand, {
      state: HandState.FINISHED,
      round_wind: Winds.SOUTH,
      hand: 3,
